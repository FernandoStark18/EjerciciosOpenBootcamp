...
// sessionStorage.setItem('Me', JSON.stringify(objMe));
// localStorage.setItem('Me', JSON.stringify(objMe));
// document.cookie = `Me=${JSON.stringify(objMe)};expires=${new Date(now.getTime() + 2 * 60000)}`;
